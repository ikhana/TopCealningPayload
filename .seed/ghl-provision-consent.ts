// .seed/ghl-provision-consent.ts
//
// Creates the three A2P consent-evidence fields in Top Cleaning's GoHighLevel
// location.
//
//   PAYLOAD_MIGRATING=true pnpm payload run .seed/ghl-provision-consent.ts
//
...
//
//   DRY=1 PAYLOAD_MIGRATING=true pnpm payload run .seed/ghl-provision-consent.ts
//
