...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const fetchMe = async () => {
      try {
        // Same-origin relative URL — avoids CORS preflight failure when the
        // page is on www.topcleaningteam.com but NEXT_PUBLIC_SERVER_URL points
        // to the apex (or vice versa). The browser blocks preflight redirects.
