...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        // Base styles
        'flex h-10 w-full items-center justify-between gap-2 rounded-md bg-transparent px-3 py-2 text-sm transition-[border-color,box-shadow] outline-none whitespace-nowrap',
