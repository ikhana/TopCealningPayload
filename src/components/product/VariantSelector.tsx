...
export function VariantSelector({ product }: { product: Product }) {
   ...
   * MOVED TO TOP: All hooks must be called before any conditional logic
   */
  const _combinations = useMemo(() => { // Fixed: prefixed with _ for unused variable
    if (!variantOptions) return []

    return generateCombinations(variantOptions)
  }, [variantOptions]) // Fixed: added missing dependency
