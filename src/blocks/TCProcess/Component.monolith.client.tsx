// src/blocks/TCProcess/Component.monolith.client.tsx
// "How It Works / Our Process Is Simple" — Monolith variant.
// 3-column hover-expand cards with photos. Default TCProcess variant.
...
export function TCProcessMonolith(_props: Props) {
