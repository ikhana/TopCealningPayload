...
export interface Footer {
  ...
  /**
   * Brief company description below the logo
   */
  tagline?: string | null;
  /**
   * Create 2-4 navigation sections. Each can have up to 6 links with anchor scroll support.
   */
  sections?:
    | {
        title: string;
  ...
  /**
   * Add legal/compliance links (Privacy, Terms, etc.)
   */
  legalLinks?:
    | {
        link: {
